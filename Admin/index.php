                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="edit.php?id=<?php echo escape($post['id']); ?>" class="btn btn-warning btn-md mr-3">Edit</a>
                        <a href="delete.php?id=<?php echo escape($post['id']); ?>" class="btn btn-danger btn-md" 
